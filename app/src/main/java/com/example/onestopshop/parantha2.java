 ...
 */
public class parantha2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parantha2);
    }
    ...
    public void submitOrder(View view) {
        ...
        if (numberOfparantha == 0) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Satu parantha order for " + name);
