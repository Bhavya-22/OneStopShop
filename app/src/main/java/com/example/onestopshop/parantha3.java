 ...
 */
public class parantha3 extends AppCompatActivity {
    int numberOfparantha = 0 ;
    int basePrice = 20;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parantha3);
    }
    ...
    public void submitOrder(View view) {
        ...
        if (numberOfparantha == 0) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Paneer parantha order for" + name);
